...
public class WordpressConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void testGetBlogUsersWithOptionalParameters() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:getBlogUsers");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + connectorProperties.getProperty("domain") + "/users?fields=ID,login,email&order=ASC&order_by=ID";
        ...
        Assert.assertEquals(esbRestResponse.getBody().get("found"), apiRestResponse.getBody().get("found"));
        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("users").length(), apiRestResponse.getBody().getJSONArray("users").length());
        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("users").getJSONObject(0).length(), apiRestResponse.getBody().getJSONArray("users").getJSONObject(0).length());
        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("users").getJSONObject(0).get("ID"), apiRestResponse.getBody().getJSONArray("users").getJSONObject(0).get("ID"));
    ...
    public void testGetBlogUsersWithNegativeParameters() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:getBlogUsers");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "imirshadhassan.com/users";
    ...
    public void testCreatePostWithOptionalParameters() throws Exception {
        ...
        parametersMap.put("post_id_optional", esbRestResponse.getBody().getString("ID"));

        String apiEndPoint = connectorProperties.getProperty("apiUrl") + connectorProperties.getProperty("domain") + "/posts/" + parametersMap.get("post_id_optional") ;
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
     ...
     */
    @Test(dependsOnMethods = {"testCreatePostWithMandatoryParameters"}, groups = { "wso2.esb" }, description = "wordpress {getPostById} integration test with Mandatory Parametors.")
     ...
     */
    @Test(dependsOnMethods = {"testCreatePostWithMandatoryParameters"}, groups = { "wso2.esb" }, description = "wordpress {getPostById} integration test with optional Parametors.")
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "wordpress {getPostById} integration test with Negative Parametors.")
     ...
     */
    @Test(dependsOnMethods = {"testEditPostWithOptionalParameters"}, groups = { "wso2.esb" }, description = "wordpress {getPostBySlug} integration test with Mandatory Parametors.")
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "wordpress {getPostBySlug} integration test with Negative Parametors.")
    ...
    public void testInsertCategoryWithMandatoryParameters() throws Exception {
        ...
        parametersMap.put("slug", esbRestResponse.getBody().getString("slug"));

        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") +"/categories/slug:" + parametersMap.get("slug") ;
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    public void testInsertCategoryWithNegativeParameters() throws Exception {
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") +"/categories/new";
     ...
     */
    @Test(priority=1, groups = { "wso2.esb" }, description = "wordpress {insertTag} integration test with mandatory parameters.")
    public void testInsertTagWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") +"/tags/slug:" + parametersMap.get("tagSlugMandatory") ;
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
     ...
     */
    @Test(priority=2, groups = { "wso2.esb" }, description = "wordpress {insertTag} integration test with optional parameters.")
    public void testInsertTagWithOptionalParameters() throws Exception {
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") +"/tags/slug:" + parametersMap.get("tagSlugOptional") ;
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    public void testInsertTagWithNegativeParameters() throws Exception {
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") +"/tags/new";
    ...
    public void testEditCategoryWithMandatoryParameters() throws Exception {
        ...
        parametersMap.put("name",parametersMap.get("slug"));
        ...
        parametersMap.put("edited_slug", esbRestResponse.getBody().getString("slug"));

        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") +"/categories/slug:" + parametersMap.get("edited_slug") ;
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
     ...
     */
    @Test(dependsOnMethods = {"testEditCategoryWithMandatoryParameters"}, groups = { "wso2.esb" }, description = "wordpress {editCategory} integration test with mandatory parameters.")
    public void testEditCategoryWithOptionalParameters() throws Exception {
        parametersMap.put("name",parametersMap.get("edited_slug"));
    ...
    public void testEditCategoryWithNegativeParameters() throws Exception {
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") +"/categories/slug:thefalsename";
     ...
     */
    @Test(priority=3, groups = { "wso2.esb" }, description = "wordpress {editTag} integration test with mandatory parameters.")
    public void testEditTagWithMandatoryParameters() throws Exception {

        parametersMap.put("tag",parametersMap.get("tagSlugMandatory"));
        ...
        parametersMap.put("tagEditedSlug", esbRestResponse.getBody().getString("slug"));

        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") +"/tags/slug:" + parametersMap.get("tagEditedSlug") ;
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
     ...
     */
    @Test(priority=4, groups = { "wso2.esb" }, description = "wordpress {editTag} integration test with optional parameters.")
    public void testEditTagWithOptionalParameters() throws Exception {

        parametersMap.put("tag",parametersMap.get("tagEditedSlug"));
        ...
        parametersMap.put("tag", esbRestResponse.getBody().getString("name"));

        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") +"/tags/slug:" + esbRestResponse.getBody().getString("slug") ;
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    public void testEditTagWithNegativeParameters() throws Exception {
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") +"/tags/slug:*" ;
     ...
     */
    @Test(dependsOnMethods = {"testInsertCategoryWithMandatoryParameters","testInsertCategoryWithOptionalParameters"}, groups = { "wso2.esb" }, description = "wordpress {getCategories} integration test with mandatory parameters.")
    public void testGetCategoriesWithManditoryParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:getCategories");
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") + "/categories";
     ...
     */
    @Test(dependsOnMethods = {"testInsertCategoryWithMandatoryParameters","testInsertCategoryWithOptionalParameters"}, groups = { "wso2.esb" }, description = "wordpress {getCategories} integration test with negative parameters.")
     ...
     */
    @Test(dependsOnMethods = {"testInsertTagWithMandatoryParameters","testInsertTagWithOptionalParameters"}, groups = { "wso2.esb" }, description = "wordpress {getTags} integration test with mandatory parameters.")
    public void testGetTagsWithManditoryParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:getTags");
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") + "/tags";
     ...
     */
    @Test(dependsOnMethods = {"testInsertTagWithMandatoryParameters","testInsertTagWithOptionalParameters"}, groups = { "wso2.esb" }, description = "wordpress {getTags} integration test with negative parameters.")
    public void testGetTagsWithNegativeParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:getTags");
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/imirshadhassan.com/tags";
    ...
    /**
     * Positive test case for deleteCategory method.
     */
    @Test(dependsOnMethods = {"testEditCategoryWithOptionalParameters"}, groups = { "wso2.esb" }, description = "wordpress {deleteCategory} integration test.")
    public void testDeleteCategoryWithMandatoryParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:deleteCategory");
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") + "/categories/slug:" + parametersMap.get("edited_slug");

        parametersMap.put("category",parametersMap.get("edited_slug"));
    ...
    public void testDeleteCategoryWithNegativeParameters() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:deleteCategory");
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") + "/categories/slug:*/delete";
...
//    /**
//     * Positive test case for deleteTag method.
//     */
//    @Test(priority=18, groups = { "wso2.esb" }, description = "wordpress {deleteTag} integration test.")
//    public void testDeleteTagWithMandatoryParameters() throws Exception {
//
//        esbRequestHeadersMap.put("Action", "urn:deleteTag");
//        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") + "/tags/slug:" + parametersMap.get("tag_edited_slug");
//
//        parametersMap.put("tag",parametersMap.get("tag_edited_slug"));
//
...
//    }
    ...
    public void testDeleteTagWithNegativeParameters() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:deleteTag");
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") + "/tags/slug:*/delete";
    ...
    public void testGetFollowersWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + connectorProperties.getProperty("domain") + "/follows/";
    ...
    /**
     * Positive test case for getFollowers method with opttionl parameters.
     */
    ...
    public void testFollowBlogWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + parametersMap.get("blog") + "/follows/mine";
    ...
    public void testFollowBlogWithOptionalParameters() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:followBlog");
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" + parametersMap.get("blog") + "/follows/mine?fields=is_following";
    ...
    public void testGetPostsWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" +  connectorProperties.getProperty("domain")  + "/posts";
    ...
    public void testGetPostsWithOptionalParameters() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:getPosts");
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" +  connectorProperties.getProperty("domain")  + "/posts?fields=ID,date,URL";
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "wordpress {getPosts} integration test with Negative Parametors.")
     ...
     */
    @Test(dependsOnMethods = {"testEditPostWithOptionalParameters"},groups = { "wso2.esb" }, description = "wordpress {getLikesForPost} integration test with Mandatory Parametors.")
    public void testGetLikesForPostWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" +  connectorProperties.getProperty("domain")  + "/posts/" + parametersMap.get("postId") + "/likes/";
     ...
     */
    @Test(dependsOnMethods = {"testEditPostWithOptionalParameters"},groups = { "wso2.esb" }, description = "wordpress {getPostById} integration test with Mandatory Parametors.")
    public void testGetLikesForPostWithOptionalParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:getLikesForPost");
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" +  connectorProperties.getProperty("domain")  + "/posts/" + parametersMap.get("postId") + "/likes/?fields=found,i_like";
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "wordpress {getLikesForPost} integration test with Negative Parametors.")
    public void testGetLikesForPostWithNegativeParameters() throws Exception {

        esbRequestHeadersMap.put("Action", "urn:getLikesForPost");
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/" +  connectorProperties.getProperty("domain")  + "/posts/10000/likes/";
    ...
    public void testGetSiteInfoWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint ="https://public-api.wordpress.com/rest/v1/sites/"
                +connectorProperties.getProperty("domain");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    public void testGetSiteInfoWithNegativeCase() throws Exception {
        ...
        esbRequestHeadersMap.put("Action", "urn:getSiteInfo");
        String apiEndPoint ="https://public-api.wordpress.com/rest/v1/sites/"
                +"non-exist.wordpress.com"+"?meta=self,TEST&fields=ID,TEST";
     ...
     *(
     */
    @Test(dependsOnMethods = {"testCreatePostWithMandatoryParameters"}, groups = { "wso2.esb" }, description = "wordpress {creatComment} integration test with mandatory parameters.")
    public void testCreateCommentWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse=
                sendJsonRestRequest(proxyUrl,"POST",esbRequestHeadersMap,"esb_createComment_mandatory.txt",parametersMap);
        parametersMap.put("commentID",esbRestResponse.getBody().getString("ID"));



        String apiEndPoint= "https://public-api.wordpress.com/rest/v1/sites/"
                +connectorProperties.getProperty("domain")+"/comments/"+parametersMap.get("commentID");
        RestResponse<JSONObject> apiRestResponse=sendJsonRestRequest(apiEndPoint,"GET", apiRequestHeadersMap);
     ...
     *
     */
    @Test(dependsOnMethods = {"testCreatePostWithMandatoryParameters"}, groups = { "wso2.esb" }, description = "wordpress {creatComment} integration test with optional parameters.")
    public void testCreateCommentWithOptionalParameters() throws Exception {
        ...
        String apiEndPoint= "https://public-api.wordpress.com/rest/v1/sites/"
                +connectorProperties.getProperty("domain")+"/comments/"+parametersMap.get("commentID2")
                +"?meta=self,post";
        RestResponse<JSONObject> apiRestResponse=sendJsonRestRequest(apiEndPoint,"GET", apiRequestHeadersMap);
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "wordpress {creatComment} integration test with negative case")
    public void testCreateCommentWithNegativeCase() throws Exception {
        ...
        String apiEndPoint= "https://public-api.wordpress.com/rest/v1/sites/"
                +"non-exist.wordpress.com"+"/comments/"+parametersMap.get("commentID")
                +"?meta=self,post";
        RestResponse<JSONObject> apiRestResponse=sendJsonRestRequest(apiEndPoint,"GET", apiRequestHeadersMap);
     ...
     */
    @Test(groups={"wso2.esb"},description= "wordpress {editComment} integration test with negative case")
    public void testEditCommentWithNegativeCase() throws Exception{
        ...
        String apiEndPoint= "https://public-api.wordpress.com/rest/v1/sites/"
                +"non-exist.wordpress.com"+"/comments/"+parametersMap.get("commentID2");
        RestResponse<JSONObject> apiRestResponse=sendJsonRestRequest(apiEndPoint,"GET", apiRequestHeadersMap);
    ...
    public void testGetCommentsWithMandatoryParameters() throws Exception{
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/"
                +connectorProperties.getProperty("domain")+"/posts/"+parametersMap.get("postId")+"/replies";
        RestResponse<JSONObject> apiRestResponse=sendJsonRestRequest(apiEndPoint,"GET", apiRequestHeadersMap);
    ...
    public void testGetCommentsWithNegativeCase() throws Exception{
        ...
        String apiEndPoint = "https://public-api.wordpress.com/rest/v1/sites/"
                +"non-exist.wordpress.com"+"/posts/"+"24"+"/replies"
    ...
    public  void testGetRecentCommentsWithMandatoryParameters() throws Exception{
        ...
        String apiEndPoint="https://public-api.wordpress.com/rest/v1/sites/"
                +connectorProperties.getProperty("domain")+"/comments";
        RestResponse<JSONObject> apiRestResponse=sendJsonRestRequest(apiEndPoint,"GET",apiRequestHeadersMap);
    ...
    public  void testGetRecentCommentsWithNegativeCase() throws Exception{
        ...
        String apiEndPoint="https://public-api.wordpress.com/rest/v1/sites/"
                +"non-exist.wordpress.com"+"/comments"
                +"?meta=self,site,post&fields=ID,post,author,meta&order=DESC";
        RestResponse<JSONObject> apiRestResponse=sendJsonRestRequest(apiEndPoint,"GET",apiRequestHeadersMap);
     ...
     *
     */
    @Test(priority = 15,groups = {"wso2.esb"}, description = "wordpress {deleteComment} integration test with mandatory parameters.")
    public void testDeleteCommentWithMandatoryParameters() throws Exception{
        esbRequestHeadersMap.put("Action","urn:deleteComment");
        RestResponse<JSONObject> esbRestResponse=
                sendJsonRestRequest(proxyUrl,"POST", esbRequestHeadersMap, "esb_deleteComment_mandatory.txt",parametersMap);

        String apiEndPoint ="https://public-api.wordpress.com/rest/v1/sites/"
                +connectorProperties.getProperty("domain")+"/comments/"
                +parametersMap.get("commentID")+ "/delete";
        RestResponse<JSONObject> apiRestResponse=sendJsonRestRequest(apiEndPoint,"POST",apiRequestHeadersMap);
        apiRestResponse=sendJsonRestRequest(apiEndPoint,"POST",apiRequestHeadersMap);
     ...
     *
     */
    @Test(priority = 16,groups = {"wso2.esb"}, description = "wordpress {deleteComment} integration test with optional parameters.")
    public void testDeleteCommentWithOptionalParameters() throws Exception{
        esbRequestHeadersMap.put("Action","urn:deleteComment");
        RestResponse<JSONObject> esbRestResponse=
                sendJsonRestRequest(proxyUrl,"POST", esbRequestHeadersMap, "esb_deleteComment_optional.txt",parametersMap);

        String apiEndPoint ="https://public-api.wordpress.com/rest/v1/sites/"
                +connectorProperties.getProperty("domain")+"/comments/"
                +parametersMap.get("commentID2")+ "/delete"
                +"?meta=self,post&fields=ID,URL,content,meta";
        RestResponse<JSONObject> apiRestResponse=sendJsonRestRequest(apiEndPoint,"POST",apiRequestHeadersMap);
        apiRestResponse=sendJsonRestRequest(apiEndPoint,"POST",apiRequestHeadersMap);
     ...
     */
    @Test(priority = 17,groups = {"wso2.esb"}, description = "wordpress {deleteComment} integration test with negative case")
     ...
     */
    @Test(priority = 1,groups = {"wso2.esb"}, description = "wordpress {getFollowingBlogPosts} integration test with mandatory parameters.")
     ...
     */
    @Test( priority=5,groups = {"wso2.esb"}, description = "wordpress {subscribeTag} integration test with mandatory parameters.")
    public void testSubscribeTagsWithMandatoryParameters() throws Exception{
        ...
        String apiEndPoint="https://public-api.wordpress.com/rest/v1/read/tags/"+parametersMap.get("tag")+"/mine";
        RestResponse<JSONObject> apiRestResponse =sendJsonRestRequest(apiEndPoint,"GET",apiRequestHeadersMap);
     ...
     */
    @Test(priority=8,groups = {"wso2.esb"}, description = "wordpress {subscribeTag} integration test with optional parameters.")
    public void testSubscribeTagsWithOptionalParameters() throws Exception{
        ...
        String apiEndPoint="https://public-api.wordpress.com/rest/v1/read/tags/"+parametersMap.get("tag")+"/mine?fields=subscribed";
        RestResponse<JSONObject> apiRestResponse =sendJsonRestRequest(apiEndPoint,"GET",apiRequestHeadersMap);
     ...
     */
    @Test(priority=6,groups = {"wso2.esb"}, description = "wordpress {subscribeTag} integration test with negative case.")
    public void testSubscribeTagsWithNegativeCase() throws Exception{
        ...
        String apiEndPoint="https://public-api.wordpress.com/rest/v1/read/tags/"+parametersMap.get("tag")+"/mine/new";
        RestResponse<JSONObject> apiRestResponse =sendJsonRestRequest(apiEndPoint,"POST",apiRequestHeadersMap);
     ...
     */
    @Test(priority=7,groups = {"wso2.esb"}, description = "wordpress {unsubscribeTag} integration test with mandatory parameters.")
     ...
     */
    @Test(priority=10,groups = {"wso2.esb"}, description = "wordpress {unsubscribeTag} integration test with negative case.")
    public void testUnsubscribeTagsWithNegativeCase() throws Exception{
        ...
        String apiEndPoint="https://public-api.wordpress.com/rest/v1/read/tags/"+parametersMap.get("tag")+"/mine/delete";
        RestResponse<JSONObject> apiRestResponse =sendJsonRestRequest(apiEndPoint,"POST",apiRequestHeadersMap);
     ...
     */
    @Test(priority=9,groups = {"wso2.esb"}, description = "wordpress {unsubscribeTag} integration test with optional parameters.")
     ...
     *
     */
    @Test(priority = 1,groups={"wso2.esb"},description = "wordpress {getSearchTerms} integration test with mandatory parameters")
     ...
     *
     */
    @Test(priority = 1,groups={"wso2.esb"},description = "wordpress {getStats} integration test with mandatory parameters")
    public void testGetStatsWithMandatoryParameters() throws Exception{
        ...
        String apiEndPoint="https://public-api.wordpress.com/rest/v1/sites/"+connectorProperties.getProperty("domain")+"/stats";
        RestResponse<JSONObject> apiRestResponse= sendJsonRestRequest(apiEndPoint,"GET",apiRequestHeadersMap);
    ...
    public void testGetStatsWithNegativeCase() throws Exception{
        ...
        String apiEndPoint="https://public-api.wordpress.com/rest/v1/sites/"+"non-exist.wordpress.com"+"/stats"
                +"?fields=stats,day";
        RestResponse<JSONObject> apiRestResponse= sendJsonRestRequest(apiEndPoint,"GET",apiRequestHeadersMap);
     ...
     *
     */
    @Test(priority = 1,groups={"wso2.esb"},description = "wordpress {getViewsByCountry} integration test with mandatory parameters")
     ...
     */
    @Test(priority = 1,groups={"wso2.esb"},description = "wordpress {getVisitorsCount} integration test with mandatory parameters")
     ...
     */
    @Test(priority = 1,groups={"wso2.esb"},description = "wordpress {getVisitorsCount} integration test with optional parameters")
     ...
     */
    @Test(groups={"wso2.esb"},description = "wordpress {getVisitorsCount} integration test with negative case")
